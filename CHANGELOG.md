...
## [0.1.1](https://github.com/lespaceman/athena-flow/compare/athena-flow-v0.1.0...athena-flow-v0.1.1) (2026-02-26)


### Features

* add availableWidth prop to all tool output renderers ([7ea88cc](https://github.com/lespaceman/athena-flow/commit/7ea88cc56a4a5f447bcff056ca3958f01d8f4d59))
...
* add dark/light theme support ([08f9554](https://github.com/lespaceman/athena-flow/commit/08f9554e2a3d6e5860903c791eb87d4bd24aadc3))
...
* add extractors for NotebookEdit, Task and improve unknown tool fallback ([94f1ab1](https://github.com/lespaceman/athena-flow/commit/94f1ab106b41cf4415e6dc500c21cf5c6eace2b7))
...
* add multiline input, forward-delete, and command suggestion submit ([a7f939d](https://github.com/lespaceman/athena-flow/commit/a7f939de052dd59a56d06da0d3ab19fff9549cf5))
* add rich tool output rendering with extractors and markdown support ([027f8d2](https://github.com/lespaceman/athena-flow/commit/027f8d2904f054cbfbdd446c828ac6797de2c935))
...
* add session restoration with CLI flags and in-app picker ([e1cbf23](https://github.com/lespaceman/athena-flow/commit/e1cbf23e9223b78437f43cbe72b1f4f213733335))
* add session restoration with CLI flags and in-app picker ([900fbf0](https://github.com/lespaceman/athena-flow/commit/900fbf0883b48e3579de63c68ce40b382ae8f9ed))
...
* add truncation to DiffBlock and MarkdownText renderers ([1b96ab4](https://github.com/lespaceman/athena-flow/commit/1b96ab4e55eed60d541d58ce2d30337031e648bd))
...
* add UnifiedToolCallEvent component for combined tool call + result rendering ([9c26dc9](https://github.com/lespaceman/athena-flow/commit/9c26dc9e2bb956b9fe031ca878100d51f0d207dc))
...
* multiline input, forward-delete, and command suggestion submit ([937e44b](https://github.com/lespaceman/athena-flow/commit/937e44b5f6615c26693e89335ddd89b29af9e2fb))
* pair PreToolUse with PostToolUse/PostToolUseFailure by toolUseId ([f5e76b9](https://github.com/lespaceman/athena-flow/commit/f5e76b9a898549220494ac2c6027c0a88c3abcae))
...
* rich tool output rendering ([036e2a5](https://github.com/lespaceman/athena-flow/commit/036e2a506e8c6ba08413b66281af98fae14d2b05))
...
* unify tool call + result into single display with pulsating indicator ([abbad6a](https://github.com/lespaceman/athena-flow/commit/abbad6a77120d75d8e4a255905b974dd876a8b7f))
...
* add ⎿ prefix to tool output, render WebSearch as markdown, fix table truncation ([27074ee](https://github.com/lespaceman/athena-flow/commit/27074eee4564287f66b682706c52de40ec7af230))
...
* correct /stats total and add context size display ([66cc9a6](https://github.com/lespaceman/athena-flow/commit/66cc9a68ffb97e5097892496140791206dd6eb4f))
* correct /stats total to include cache tokens and add context size display ([38c55b0](https://github.com/lespaceman/athena-flow/commit/38c55b0dfcc3daca7981e4111aeeb8e7459ceca4))
...
* migrate SessionPicker to useTheme and update design doc ([8dac606](https://github.com/lespaceman/athena-flow/commit/8dac6069e2e361cae52a011f9f135e43d328c4d3))
* pair PostToolUse events missing tool_use_id via temporal fallback ([da36e6b](https://github.com/lespaceman/athena-flow/commit/da36e6b6b8d2a5fd782b42cef5bdd6e8da38168c))
...
* prevent hanging tool call indicators when tool_use_id is absent ([4d94afc](https://github.com/lespaceman/athena-flow/commit/4d94afcb7015d3f2ecacb6de890cdd4a130a7031))
...
* remove option descriptions and trim options to match Claude Code UX ([fcae628](https://github.com/lespaceman/athena-flow/commit/fcae62855384bc9a093a2eeb3abac771cd023754))
...
* reset sessionEnded flag when new session starts ([be669f9](https://github.com/lespaceman/athena-flow/commit/be669f9a43585280e1dbd181821a281b25695d3f))
...
* theme flag precedence and add component-level theme tests ([a0251bb](https://github.com/lespaceman/athena-flow/commit/a0251bb889aa0fee3c21cb4a4e7d3263cbf089d7))
...
* tool calls stuck as Running on second message ([40c2994](https://github.com/lespaceman/athena-flow/commit/40c2994995d291ba44a722bda40de7502aca5c69))
* tool output rendering — ⎿ prefix, WebSearch markdown, table truncation ([ab74e52](https://github.com/lespaceman/athena-flow/commit/ab74e5294b849b61a6077debf2bdaeb53ba04ef4))
